...
COMMON_PACKAGES="alacritty neovim zip unzip most zathura zathura-pdf-poppler zathura-pdf-mupdf pcmanfm dunst mpv htop stow imv wget tmux pipewire brightnessctl ripgrep fd-find lsd bat zoxide fzf zsh zsh-syntax-highlighting zsh-autosuggestions nitrogen keepassxc syncthing inkscape qbittorrent flameshot udiskie foliate jetbrains-mono-fonts"

NOT_COMMON_PACKAGES="vivid github-cli tokei dua-cli"
